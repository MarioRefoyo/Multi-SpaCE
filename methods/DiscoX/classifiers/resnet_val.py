'''This code was written by the authors of "Deep learning for time series classification: a review".
We made some modifications including adding a validation set and limiting the training-validation process
to the training set and validation set'''
...
class Classifier_RESNET:
    ...
    def fit(self, x_train, y_train, nb_epochs=1500):
